...
@section('contenido')
    ...
    <div class="breadcumb-area bg-img bg-overlay" style="background-image: url(sitetemplate/img/bg-img/breadcumb.jpg);">
        ...
        <div class="row">
            ...
            <div class="col-12 col-lg-4">
                <div class="about-thumb">
                    <img src="sitetemplate/img/bg-img/man.png" alt="">
                </div>
            </div>
        </div>
    </div>
